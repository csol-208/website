...
Course Objectives
- Work effectively in teams; get to know the instructor and classmates.
- Experience and understand the fundamentals of data science workflows - including data ingest and cleaning to exploratory data analysis, principles data visualization, to dynamic applications.
- Be able to generate concise and interpretable python code that performs these tasks through the use of Large Language Models in an integrated development environment. 

Course is only for students enrolled in the Masters of Climate Solutions, <https://climatesolutions.berkeley.edu/>